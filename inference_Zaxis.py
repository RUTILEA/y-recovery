...
class InspectorZaxis:
    ...
    def _set_exclusion_area(self):
        self.exclusion_area_positive = [
            ...
            (60, 410, 50, 965, 505, 83),  # 上の黒い線
            (60, 550, 0, 965, 585, 43),  # 下の黒い線
            (60, 525, 44, 965, 610, 83),  # 下の黒い線
        ...
        self.exclusion_area_negative = [
            ...
            (990, 410, 0, 1010, 430, 45),  # 四隅の出っ張り
            (990, 600, 0, 1010, 620, 45),  # 四隅の出っ張り
            # (60, 440, 0, 965, 475, 80),  # 上の黒い線
            (60, 550, 0, 965, 585, 80),  # 下の黒い線
            (0, 405, 95, 95, 620, 155),  # 左もや
            (930, 405, 95, 1024, 620, 155),  # 右もや
            (60, 550, 100, 965, 585, 80),  # 下の黒い線
