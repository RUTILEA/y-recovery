...
class InspectorZaxis:
    ...
    def _set_exclusion_area(self):
        self.exclusion_area_positive = [
            ...
            (0, 300, 0, 90, 700, 256),  # 左端
            (935, 300, 0, 1024, 700, 256),  # 右端
            (0, 0, 0, 1024, 1024, 13),  # 開始直後
            ...
            (60, 410, 50, 965, 510, 90),  # 上の黒い線
            (60, 550, 0, 965, 585, 38),  # 下の黒い線
            (60, 525, 39, 965, 610, 90),  # 下の黒い線
            ...
            (105, 600, 90, 295, 610, 145),  # 白線エリア
            (730, 440, 90, 920, 445, 145),  # 白線エリア
            (495, 405, 78, 525, 620, 168),  # 中央の白い点*
            (355, 405, 90, 375, 620, 180),  # 中央左側の白い点
            (645, 405, 90, 665, 620, 180),  # 中央右側の白い点
            (95, 405, 78, 105, 620, 168),  # 左部左側の白い点*
            (295, 405, 78, 305, 620, 168),  # 左部右側の白い点*
            (720, 405, 78, 730, 620, 168),  # 右部左側の白い点*
            (920, 405, 78, 930, 620, 168),  # 右部右側の白い点*
            (460, 445, 98, 475, 570, 180),  # 中央すぐ左の白い点*
            (540, 445, 98, 555, 570, 180),  # 中央すぐ右の白い点*
            (390, 470, 90, 405, 550, 168),  # 中央左側中央の白い点**
            (615, 470, 90, 630, 550, 168),  # 中央右側中央の白い点**
            ...
            (305, 405, 90, 315, 620, 168),  # 左部右端の白い点*
            (710, 405, 90, 720, 620, 168),  # 右部左端の白い点*
            ...
            (405, 400, 140, 410, 580, 168),  # 中央の左側の一時的な白い領域**
            (455, 400, 140, 460, 580, 168),  # 中央の左側の一時的な白い領域**
            (560, 435, 140, 565, 615, 168),  # 中央の右側の一時的な白い領域**
            (620, 435, 140, 625, 615, 168),  # 中央の右側の一時的な白い領域**
            (120, 405, 142, 145, 620, 168),  # 右部ビード部の境界**
            (880, 405, 142, 905, 620, 168),  # 左部ビード部の境界**
            (110, 400, 157, 340, 440, 209),  # 左部ビード部上
            (110, 575, 157, 340, 620, 209),  # 左部ビード部下
            (110, 400, 157, 120, 620, 209),  # 左部ビード部左
            (300, 400, 157, 340, 620, 209),  # 左部ビード部右
            (685, 400, 157, 915, 440, 209),  # 右部ビード部上
            (685, 575, 157, 915, 620, 209),  # 右部ビード部下
            ...
            (0, 405, 180, 110, 620, 200),  # 左もや
            (915, 405, 180, 1024, 620, 200),  # 右もや
            (40, 590, 185, 985, 605, 210),  # 下部のもや
            # (80, 395, 230, 990, 405, 240),  # 物体上部の境界**
            # (80, 620, 230, 990, 630, 240),  # 物体下部の境界**
            (630, 500, 210, 655, 525, 265),  # 画面右部の白丸**
            (490, 490, 191, 535, 535, 256),  # 中央の白点
            (150, 450, 235, 170, 470, 256),  # 左ビード左上
            (150, 545, 235, 170, 565, 256),  # 左ビード左下
            (255, 450, 235, 275, 470, 256),  # 左ビード右上
            (255, 545, 235, 275, 565, 256),  # 左ビード右下
            (745, 450, 235, 765, 470, 256),  # 右ビード左上
            (745, 545, 235, 765, 565, 256),  # 右ビード左下
            (850, 450, 235, 870, 470, 256),  # 右ビード右上
            (850, 545, 235, 870, 565, 256),  # 右ビード右下
        ]
        ...
        self.exclusion_area_negative = [
            ...
            (0, 0, 0, 1024, 1024, 13),  # 開始直後
            (400, 490, 0, 625, 535, 85),  # 中央のムラ
            (20, 600, 0, 40, 620, 45),  # 四隅の出っ張り
            (20, 410, 0, 40, 430, 45),  # 四隅の出っ張り
            (990, 410, 0, 1010, 430, 45),  # 四隅の出っ張り
            (990, 600, 0, 1010, 620, 45),  # 四隅の出っ張り
            (60, 455, 60, 965, 460, 85),  # 上の黒い線
            (60, 550, 0, 965, 585, 60),  # 下の黒い線
            (60, 525, 61, 965, 610, 85),  # 下の黒い線
            (0, 405, 95, 90, 620, 155),  # 左もや
            (0, 405, 156, 75, 620, 165),  # 左もや
            (930, 405, 90, 1024, 620, 155),  # 右もや
            (950, 405, 156, 1024, 620, 165),  # 右もや
            (495, 405, 82, 525, 620, 165),  # 中央の白い点*
            (355, 405, 90, 375, 620, 180),  # 中央左側の白い点
            (645, 405, 90, 665, 620, 180),  # 中央右側の白い点
            (95, 405, 82, 110, 620, 165),  # 左部左側の白い点*
            (290, 405, 82, 305, 620, 165),  # 左部右側の白い点
            (720, 405, 82, 735, 620, 165),  # 右部左側の白い点
            (915, 405, 82, 930, 620, 165),  # 右部右側の白い点*
            (460, 460, 98, 475, 570, 170),  # 中央すぐ左の白い点*
            (540, 460, 98, 555, 570, 170),  # 中央すぐ右の白い点*
            ...
            (545, 600, 110, 575, 610, 140),  # ギザギザ (4,3))/(4,4)
