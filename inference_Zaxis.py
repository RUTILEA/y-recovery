...
class InspectorZaxis:
    ...
    def _set_exclusion_area(self):
        self.exclusion_area_positive = [
            ...
            (60, 550, 0, 965, 585, 45),  # 下の黒い線
            (60, 525, 46, 965, 610, 83),  # 下の黒い線
            ...
            (495, 405, 78, 525, 620, 167),  # 中央の白い点*
            (355, 405, 90, 375, 620, 180),  # 中央左側の白い点
            (645, 405, 90, 665, 620, 180),  # 中央右側の白い点
            (95, 405, 78, 105, 620, 167),  # 左部左側の白い点*
            (295, 405, 78, 305, 620, 167),  # 左部右側の白い点*
            (720, 405, 78, 730, 620, 167),  # 右部左側の白い点*
            (920, 405, 78, 930, 620, 167),  # 右部右側の白い点*
            (460, 445, 98, 475, 570, 180),  # 中央すぐ左の白い点*
            (540, 445, 98, 555, 570, 180),  # 中央すぐ右の白い点*
            (390, 470, 90, 405, 550, 167),  # 中央左側中央の白い点**
            (615, 470, 90, 630, 550, 167),  # 中央右側中央の白い点**
            ...
            (305, 405, 90, 315, 620, 167),  # 左部右端の白い点*
            (710, 405, 90, 720, 620, 167),  # 右部左端の白い点*
            ...
            (405, 400, 140, 410, 580, 167),  # 中央の左側の一時的な白い領域**
            (455, 400, 140, 460, 580, 167),  # 中央の左側の一時的な白い領域**
            (560, 435, 140, 565, 615, 167),  # 中央の右側の一時的な白い領域**
            (620, 435, 140, 625, 615, 167),  # 中央の右側の一時的な白い領域**
            (120, 405, 142, 145, 620, 167),  # 右部ビード部の境界**
            (880, 405, 142, 905, 620, 167),  # 左部ビード部の境界**
