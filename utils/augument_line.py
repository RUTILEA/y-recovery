...
ok_images_path = os.path.join(dataset_path, "crop_image", "oblieque2")
ng_images_path = os.path.join(dataset_path, "substance", "single", "oblieque2_difficult_coco2")
annotations_file_path = os.path.join(ng_images_path, "annotations.json")
output_dir = os.path.join(dataset_path, "dataset", "oblieque2_difficult_crop3", "train")
